...
def compare_structure(path):
        ...
        return list_finish
c1 = compare_structure("/home/e220314/link-nfs/Yakiv/ansible_1/host_vars/xadago/test/wora_asm.yml")
print c1

c2 = compare_structure("/home/e220314/link-nfs/Yakiv/ansible_1/host_vars/dlt-star-hob-st22/ora_asm.yml")
print c2
'''
#for i in (c1):
